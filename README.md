...
(Angular version used is from around 2011, thus not up to date!)

Mind you, however, this does no longer strictly resembles the original tutorial code and will deviate further.
